...
3. **Flujos End-To-End (E2E) Vitales:** Toda carga de datos (ej. carga de remuneraciones, generación de boletas mensuales, altas de farmacias o modificaciones de padrón) debe simularse con un usuario válido (`farmacia_demo` o `admin`) hasta confirmar el impacto correcto en DB, probando ocasionalmente con vistas UI en modelo móvil.
